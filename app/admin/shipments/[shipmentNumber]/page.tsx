    ...
    <div className="space-y-6 max-w-6xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-foreground/60 text-sm md:text-base">Review shipment details and perform admin actions.</p>
        </div>
                ...
                <div className="grid gap-4">
                  ...
                  {Array.isArray(shipment.parcels) && shipment.parcels.length > 0 ? (
                    <div className="rounded-xl border border-border p-4 space-y-3">
                      ...
                      <div className="h-40 overflow-y-scroll flex flex-col gap-3">
                        {shipment.parcels.map((parcel: any, index: number) => (
                          <div key={parcel.parcelId || index} className="rounded-lg border border-border p-3">
                            ...
                            <p className="text-sm text-foreground/60">Item Category: {parcel.itemCategory  || "N/A"}</p>
                            <p className="text-sm text-foreground/60">Item Qty: {parcel.amount  || "N/A"}</p>
                            ...
                            <label key={parcel.parcelId || index} className="flex items-start gap-3 rounded-xl border border-border p-4 cursor-pointer">
                              ...
                              <div className="space-y-1">
                                <div className="flex flex-wrap gap-2 items-center">
                                  ...
                                  <Badge variant="secondary" className={getStatusBadgeClass(parcel.status || "Unknown")} >
