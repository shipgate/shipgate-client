    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-foreground/70 mt-1">Create, edit, and manage all blog content</p>
        </div>
                    ...
                    <tr key={post._id} className="border-b border-border hover:bg-muted/50">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex gap-2">
                          <Link href={`/super-admin/blog/${post._id}/edit`}>
                            <Button variant="ghost" size="sm" className="text-blue-600 hover:text-white hover:bg-blue-700">
                              <Edit2 className="w-4 h-4" />
                            </Button>
                          </Link>
                          <Link href={`/super-admin/blog/${post._id}/preview`}>
