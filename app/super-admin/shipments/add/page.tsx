...
export default function SuperAdminAddShipmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/super-admin/shipments")
    } catch (err) {
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3 justify-end">
          <Button type="button" variant="outline" onClick={() => router.push("/super-admin/shipments")}>Cancel</Button>
